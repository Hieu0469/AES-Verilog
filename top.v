...
// Round 1
sub_bytes sb1(.state_in(AfterAddRoundKey[0]), .state_out(AfterSubBytes[0]));
...
//Round 2
sub_bytes sb2(.state_in(AfterAddRoundKey[1]), .state_out(AfterSubBytes[1]));
...
//Round 3
sub_bytes sb3(.state_in(AfterAddRoundKey[2]), .state_out(AfterSubBytes[2]));
...
//Round 4
sub_bytes sb4(.state_in(AfterAddRoundKey[3]), .state_out(AfterSubBytes[3]));
...
//Round 5
sub_bytes sb5(.state_in(AfterAddRoundKey[4]), .state_out(AfterSubBytes[4]));
...
//Round 6
sub_bytes sb6(.state_in(AfterAddRoundKey[5]), .state_out(AfterSubBytes[5]));
...
//Round 7
sub_bytes sb7(.state_in(AfterAddRoundKey[6]), .state_out(AfterSubBytes[6]));
...
//Round 8
sub_bytes sb8(.state_in(AfterAddRoundKey[7]), .state_out(AfterSubBytes[7]));
...
//Round 9
sub_bytes sb9(.state_in(AfterAddRoundKey[8]), .state_out(AfterSubBytes[8]));
...
//Round 10
sub_bytes sb10(.state_in(AfterAddRoundKey[9]), .state_out(AfterSubBytes[9]));
...
//Round 11
sub_bytes sb11(.state_in(AfterAddRoundKey[10]), .state_out(AfterSubBytes[10]));
...
//Round 12
sub_bytes sb12(.state_in(AfterAddRoundKey[11]), .state_out(AfterSubBytes[11]));
...
//Round 13
sub_bytes sb13(.state_in(AfterAddRoundKey[12]), .state_out(AfterSubBytes[12]));
...
//Round 14
sub_bytes sb14(.state_in(AfterAddRoundKey[13]), .state_out(AfterSubBytes[13]));
...
assign ciphertext = AfterAddRoundKey[14];
